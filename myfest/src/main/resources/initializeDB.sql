...
insert into ArtistsGenres (ArtistId, GenreId) values (1, 1)
insert into ArtistsGenres (ArtistId, GenreId) values (1, 2)
insert into ArtistsGenres (ArtistId, GenreId) values (2, 1)
insert into ArtistsGenres (ArtistId, GenreId) values (2, 4)
insert into ArtistsGenres (ArtistId, GenreId) values (3, 3)
insert into ArtistsGenres (ArtistId, GenreId) values (4, 4)
insert into ArtistsGenres (ArtistId, GenreId) values (4, 3)
insert into ArtistsGenres (ArtistId, GenreId) values (4, 2)