...
public class Songs implements java.io.Serializable {
  ...
  public Songs(int songId, Discs discs, String name, String duration, boolean state) {
    this.songId = songId;
    this.discs = discs;
    this.name = name;
  ...
  public Songs(int songId, Discs discs, String name, String duration, boolean state, String videoLink,
      String limitation) {
    this.songId = songId;
    this.discs = discs;
    this.name = name;
