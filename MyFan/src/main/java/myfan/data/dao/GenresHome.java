...
public class GenresHome {
  ...
  public void attachDirty(Genres instance) {
    log.debug("attaching dirty Genres instance");
    try {
  ...
  public void attachClean(Genres instance) {
    log.debug("attaching clean Genres instance");
    try {
  ...
  public void delete(Genres persistentInstance) {
    log.debug("deleting Genres instance");
    try {
  ...
  public Genres merge(Genres detachedInstance) {
    ...
    try {
      Genres result = (Genres) sessionFactory.getCurrentSession().merge(detachedInstance);
  ...
  public List<Genres> findByExample(Genres instance) {
    ...
    try {
      List<Genres> results = (List<Genres>) sessionFactory.getCurrentSession().createCriteria("myfan.data.models.Genres")
