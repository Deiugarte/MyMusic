...
public class ArtistsHome {
  ...
  public Artists findById(int id) {
    ...
    try {
      Artists instance = (Artists) sessionFactory.getCurrentSession().get("myfan.dao.Artists", id);
      if (instance == null) {
  ...
  public List findByExample(Artists instance) {
    ...
    try {
      List results = sessionFactory.getCurrentSession().createCriteria("myfan.dao.Artists")
