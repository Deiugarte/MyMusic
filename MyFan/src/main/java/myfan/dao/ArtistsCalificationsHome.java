 ...
 * @see myfan.models.ArtistsCalifications
...
public class ArtistsCalificationsHome {
  ...
  public ArtistsCalifications findById(int id) {
    ...
    try {
      ArtistsCalifications instance = (ArtistsCalifications) sessionFactory.getCurrentSession()
          .get("myfan.dao.ArtistsCalifications", id);
      if (instance == null) {
  ...
  public List findByExample(ArtistsCalifications instance) {
    log.debug("finding ArtistsCalifications instance by example");
    try {
      List results = sessionFactory.getCurrentSession().createCriteria("myfan.dao.ArtistsCalifications")
