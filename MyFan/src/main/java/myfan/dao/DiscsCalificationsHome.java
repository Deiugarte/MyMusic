 ...
 * @see myfan.models.DiscsCalifications
...
public class DiscsCalificationsHome {
  ...
  public DiscsCalifications findById(int id) {
    ...
    try {
      DiscsCalifications instance = (DiscsCalifications) sessionFactory.getCurrentSession()
          .get("myfan.dao.DiscsCalifications", id);
      if (instance == null) {
  ...
  public List findByExample(DiscsCalifications instance) {
    log.debug("finding DiscsCalifications instance by example");
    try {
      List results = sessionFactory.getCurrentSession().createCriteria("myfan.dao.DiscsCalifications")
