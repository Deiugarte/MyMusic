...
public class EventsHome {
  ...
  public Events findById(int id) {
    ...
    try {
      Events instance = (Events) sessionFactory.getCurrentSession().get("myfan.dao.Events", id);
      if (instance == null) {
  ...
  public List findByExample(Events instance) {
    ...
    try {
      List results = sessionFactory.getCurrentSession().createCriteria("myfan.dao.Events").add(Example.create(instance))
          .list();
